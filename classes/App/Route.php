...
class Route
{
     ...
     *
     * @throws RoutingException If the controller is invalid.
     */
    private function __construct(string $controllerOrTemplate, string $route, string $type, array $aliases = array())
    {
        ...
        if (strpos($controllerOrTemplate, "@") === false || Template::exists($controllerOrTemplate)) {
            ...
            if (strpos($controllerOrTemplate, "@") !== false) {
     ...
     *
     * @throws RoutingException If the route has already been specified.
     */
    ...
    /**
     * @param  Route  $route  The route to specify aliases for.
     ...
     *
     * @throws LeveledException If the callback is not callable.
     */
